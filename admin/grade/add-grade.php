                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <div class="page-body">
                                    <form action="addgrade.php" method="POST" class="user">
                                <div class="form-group row">
                                    <div class="col-sm-4 mb-3">
                                        <input type="text" class="form-control form-control-user" id="gradeID" name="gradeID"
                                            placeholder="Grade ID" required>
                                    </div>
