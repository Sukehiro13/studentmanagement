                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Student</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="map-google.html">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Edit User Profile</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="pcoded-hasmenu">
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <div class="card-title">List of Grades</div>
              <div class="card-category">Here is the list of Grades.</div>
            </div>
            <br />
                ...
                <div class="col-md-6">
                    ...
                    <a href="add-grade.php" class="btn btn-success btn-rounded">Add Grade to student</a>
                    </div>
                </div>
                </div>
            <div class="card-body">
